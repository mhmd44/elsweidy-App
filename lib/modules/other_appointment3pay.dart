...
import 'package:shifaa_app/modules/paying.dart';
import 'package:shifaa_app/shared/components/components.dart';
import 'package:syncfusion_flutter_datepicker/datepicker.dart';

class OtherAppointment3Pay extends StatefulWidget {
  @override
  _OtherAppointment3PayState createState() => _OtherAppointment3PayState();
}

class _OtherAppointment3PayState extends State<OtherAppointment3Pay> {
  var _value = 1;
      ...
      appBar: AppBar(
        ...
        actions: [
          InkWell(
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (context) => Paying()));
              },
            ...
            defaultButton(
                ...
                onpressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => Paying()));
                })
          ],
        ),
      ),
